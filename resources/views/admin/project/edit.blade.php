...
@section('content')
    <div class="container p-5">
        ...
        <div class="row">
            <div class="col">
                <form action="/project/{{ $blog->id }}" method="POST" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Title</label>
                        <input type="text" class="form-control @error('title') is-invalid @enderror"
                            id="exampleInputEmail1" aria-describedby="emailHelp" name="title" value="{{ $blog->title }}">
                        @error('title')
                    ...
                    <div class="form mb-3">
                        ...
                        <select class="form-select @error('category_id') is-invalid @enderror"
                            ...
                            {{-- <option selected>{{ $blog->category->name }}</option> --}}
                    ...
                    <div class="mb-3">
                        ...
                        <textarea rows="5" @error('body') is-invalid @enderror" id="body" name="body">{{ $blog->body }}</textarea>
                        @error('body')
                            <div class="invalid-feedback">
