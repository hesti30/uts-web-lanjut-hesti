                    ...
                    <div class="col-lg-8 d-flex flex-column align-items-stretch">
                        <div class="content ps-lg-4 d-flex flex-column justify-content-center">
                            <div class="row">
                                <div class="col-lg-6">
                                    <ul>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Name:</strong> <span>Hesti
                                                Setiawati</span></li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                            <span>www.example.com</span>
                                        </li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+115 20000
                                                002</span></li>
                                ...
                                <div class="col-lg-6">
                                    <ul>
                                        ...
                                        <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>BSD, Tangerang
                                                Selatan</span></li>
                                        <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong>
                                            <span>hestiiisetiawati@gmail.com</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
        ...
        <section id="resume" class="resume">
            <div class="container">
                ...
                <div class="section-title">
                    <span>My Resume</span>
                    <h2>My Resume</h2>
                    <p>Saya hesti setiawati, Saat ini saya sedang menempuh pendidikan dengan jurusan informatika di kampus
                        ...
                        dan saya bisa mempelajari suatu hal yang baru, serta dapat memberikan feedback yang menguntungkan
                        bagi perusahaan.
                    </p>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="resume-item">
                            ...
                            <ul>
                                ...
                                <li>Bertanggung jawab dan mengetahui segala pemasukan atau pengeluaran dana kegiatan
                                    himpunan</li>
